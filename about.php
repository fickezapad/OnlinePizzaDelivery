      ...
      <div id="heroCarousel" class="carousel slide carousel-fade" data-ride="carousel">
        ...
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item">
            ...
            <div class="carousel-container">
              <div class="carousel-content">
                <h2 class="animate__animated animate__fadeInDown mb-0">Filip Bogdanovic</h2>
                <p> Contact me <a href="https://github.com/darshankparmar" target="_blank">@fickezapad</a></p>
                <a href="index.php" class="btn-get-started animate__animated animate__fadeInUp scrollto">Get Started</a>
              </div>
            </div>
          </div>
            ...
            <div class="member">
              ...
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Filip Bogdanovic</h4>
                </div>
                <div class="social">
                  <a href="https://twitter.com/FilipBogdanov10" target="_blank"><i class="icofont-twitter"></i></a>
                  <a href="https://github.com/fickezapad" target="_blank"><i class="fab fa-github"></i></a>
                  <a href="https://www.linkedin.com/in/filip-bogdanovic-589149225/" target="_blank"><i class="icofont-linkedin" target="_blank"></i></a>
                </div>
              </div>
            </div>
          </div>
